...
('amboseli','amboseli','Amboseli National Park','South Rift, near Kimana','Big elephants, bigger mountain',
 ...
 'assets/img/dest-amboseli.svg', '["Game drives","Kilimanjaro viewpoints","Maasai village visit","Birdwatching"]', 'Elephants, Kilimanjaro views, short trips from Kimana', 3500),
('maasai-mara','maasai-mara','Maasai Mara National Reserve','Narok County','Home of the great wildebeest crossing',
 ...
 'assets/img/dest-mara.svg', '["Big cat game drives","Wildebeest migration (seasonal)","Hot air balloon add-on","Maasai cultural visit"]', 'Big cats, the migration, classic Kenya safari', 4200),
('tsavo-east','tsavo-east','Tsavo East National Park','Taita-Taveta County','Red elephants and open plains',
 ...
 'assets/img/dest-tsavo-east.svg', '["Game drives","Lugard Falls","Aruba Dam wildlife viewing"]', 'Red elephants, open savannah, combining with Amboseli', 3200),
('tsavo-west','tsavo-west','Tsavo West National Park','Taita-Taveta County','Volcanic hills and crystal springs',
 ...
 'assets/img/dest-tsavo-west.svg', '["Mzima Springs","Shetani Lava Flows","Game drives","Rhino sanctuary"]', 'Scenery, springs, a change of pace from open plains', 3200),
('lake-nakuru','lake-nakuru','Lake Nakuru National Park','Great Rift Valley','Flamingos on the Rift Valley floor',
 ...
 'assets/img/dest-nakuru.svg', '["Flamingo viewing","Rhino tracking","Baboon Cliff viewpoint"]', 'Flamingos, rhinos, Rift Valley scenery', 3000),
('nairobi-np','nairobi-national-park','Nairobi National Park','Nairobi','A safari with the city skyline behind it',
 ...
 'assets/img/dest-nairobi-np.svg', '["Game drives","Animal orphanage visit","Short walking trail"]', 'Airport layovers, quick half-day safaris', 2200);
...
('p1','amboseli-weekend','Amboseli Weekend Escape','Budget',3,'["amboseli"]','budget','saloon',21500,'assets/img/pkg-amboseli-weekend.svg',
...
('p2','amboseli-tsavo-circuit','Amboseli & Tsavo Circuit','Comfort',5,'["amboseli","tsavo-east","tsavo-west"]','midrange','4x4',68000,'assets/img/pkg-amboseli-tsavo.svg',
...
('p3','mara-migration-luxury','Maasai Mara Migration Luxury','Luxury',4,'["maasai-mara"]','luxury','4x4',145000,'assets/img/pkg-mara-luxury.svg',
...
('p4','rift-valley-explorer','Rift Valley Explorer','Comfort',6,'["lake-nakuru","maasai-mara"]','midrange','4x4',92000,'assets/img/pkg-rift-valley.svg',
...
('p5','kimana-day-safari','Kimana Day Safari','Budget',1,'["amboseli"]','budget','saloon',8500,'assets/img/pkg-day-safari.svg',
...
('p6','grand-southern-luxury','Grand Southern Circuit','Luxury',7,'["amboseli","tsavo-west","tsavo-east"]','luxury','4x4',210000,'assets/img/pkg-grand-southern.svg',
...
('t1','Kelly Lemayian','Founder & Lead Guide','Grew up around Kimana and Amboseli, and has been guiding visitors through the south for years.','assets/img/team-kelly.svg'),
('t2','Naserian Sankale','Bookings & Guest Care','Handles every enquiry personally — the first voice most guests hear on WhatsApp.','assets/img/team-naserian.svg'),
('t3','Joseph Mwangangi','Driver-Guide, 4x4 Fleet','Knows the Tsavo and Amboseli tracks like the back of his hand.','assets/img/team-joseph.svg'),
('t4','Grace Wanjiru','Transport Coordinator','Matches every booking to the right vehicle, from saloon cars to the safari Land Cruisers.','assets/img/team-grace.svg');
